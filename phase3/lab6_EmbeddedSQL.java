...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname AS Supplier, COUNT(*) AS Parts_Supplied FROM Suppliers S, Catalog C WHERE C.sid = S.sid GROUP BY S.sname";
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname AS Supplier, COUNT(*) AS Parts_Supplied FROM Suppliers S, Catalog C WHERE C.sid = S.sid GROUP BY S.sname HAVING COUNT(*) > 2";
   ...
   public static void Query3(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, COUNT(*) FROM Suppliers S, Catalog C WHERE S.sid=C.sid AND S.sname IN ( SELECT S.sname FROM Suppliers S, Catalog C WHERE S.sid=C.sid EXCEPT SELECT S.sname FROM Suppliers S, Catalog C WHERE S.sid=C.sid AND C.pid IN ( SELECT P.pid FROM Parts P WHERE P.color != 'Green')) GROUP BY S.sname";
   ...
   public static void Query4(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, MAX(C.cost) FROM Suppliers S, Catalog C WHERE S.Sid IN (SELECT S.sid FROM Suppliers S, Catalog C, Parts P WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Red' INTERSECT SELECT S.sid FROM Suppliers S, Catalog C, Parts P WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Green') AND S.sid = C.sid GROUP BY S.sname";
   ...
   public static void Query6(EmbeddedSQL esql){
      try{
         String query = "SELECT S.address FROM Suppliers S, Catalog C, Parts P WHERE S.sid=C.sid AND P.pid=C.pid AND P.pname='";
